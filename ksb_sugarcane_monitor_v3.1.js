// ============================================================================================================
// KENYA SUGAR BOARD (KSB) - SUGARCANE MONITORING SYSTEM v3.1 PRODUCTION
// ============================================================================================================
...
// Date: November 2025
// Version: 3.1 - UI/UX FIXES
//
// FIXES IN v3.1:
// 1. ✅ Action buttons now clearly visible (no text behind banners)
// 2. ✅ Added "Clear Map" button to reset view
// 3. ✅ Added Sub-County dropdown (Kenya admin level 3)
// 4. ✅ Fixed Age Classification display on ROI
// ============================================================================================================
...
function runAnalysis() {
  ...
  s2Month.size().evaluate(function(count, error) {
    ...
    if (analysisMode === 'Vegetation Index') {
      ...
      statusLabel.setValue('✓ ' + selectedIndex + ' displayed');
...
function performMLAnalysis(median, aoi, aoiGeometry, analysisScale, threshold, analysisMode,
  ...
  trainingSet.aggregate_histogram('landcover').evaluate(function(counts, error) {
    ...
    if (analysisMode === 'Sugarcane Detection') {
      ...
      statusLabel.setValue('✓ Detection complete');
      statusLabel.style().set('color', '#2E7D32');
      ...
      // FIX #4: Ensure age is properly masked to sugarcane areas
      ageClass = ageClass.updateMask(sugarcaneMask).selfMask();  // Added .selfMask()
      STATE.currentAnalysis.age = ageClass;

      // FIX #4: Use opacity and ensure it displays on ROI
...
print('═══════════════════════════════════════════════════════════');
print('✓ KSB Sugarcane Intelligence System v3.1');
print('═══════════════════════════════════════════════════════════');
print('🆕 NEW IN v3.1:');
print('  1. ✅ Action buttons now clearly visible');
print('  2. ✅ Clear Map button added');
print('  3. ✅ Sub-County selection supported');
print('  4. ✅ Age classification display fixed');
print('');
print('📍 Coverage: 12 sugar-producing regions');
